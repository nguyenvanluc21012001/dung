...
<body>
<%
String sanpham_id = request.getAttribute("sanpham_id") + "";
sanpham_id = (sanpham_id.equals("null")) ? "1" : sanpham_id;
...
<div class="container">
		...
		<form class="form" action="suasanphamxong" method="post">
		    <input type="hidden" name="sanpham_id" value="<%=sp%>">
			<div class="mb-3">
