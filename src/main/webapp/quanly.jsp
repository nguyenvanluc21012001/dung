	...
	<div class="container" style="border: 2px; margin-top: 100px">
		<div class="row">
			...
			<div class="row col-lg-12 quanLyDanhMuc" style="padding: 10px">
				...
				<div class="col-lg-6"><a href="http://localhost:8080/baitap/quanlydanhmuc.jsp">QUẢN LÝ DANH MỤC</a></div>
			</div>
			...
			<div class="row col-lg-12 quanLySanPham" style="padding: 10px">
				<div class="col-lg-5"></div>
				<div class="col-lg-1">
					<svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill="currentColor" class="bi bi-bag" viewBox="0 0 16 16">
                         <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5zM2 5h12v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5z" />
                    </svg>
				</div>
				<div class="col-lg-6"><a href="http://localhost:8080/baitap/quanlysanpham.jsp">QUẢN LÝ SẢN PHẨM</a></div>
			</div>
			...
			<div class="row col-lg-12 quanLyDonHang" style="padding: 10px">
				...
				<div class="col-lg-6"><a href="http://localhost:8080/baitap/quanlydonhang.jsp">QUẢN LÝ ĐƠN HÀNG</a></div>
			</div>
			...
			<div class="row col-lg-12 quanLyPhanHoi" style="padding: 10px">
				...
				<div class="col-lg-6"><a href="http://localhost:8080/baitap/quanlyphanhoi.jsp">QUẢN LÝ PHẢN HỒI</a></div>
			</div>
